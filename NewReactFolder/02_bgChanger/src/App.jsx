...
function App() {
  ...
  return (
    <>
      <div className='w-full h-screen bg-slate-600 duration-200' style={{backgroundColor:color}} >
        <div className='fixed flex items-end justify-center bottom-12 bg-whit inset-x-0 px-2'>
